...
public class WebHarvestTaskBuilder {
    ...
    public WebharvestTaskInput buildTaskInput(RuntimeSettings settings, Map<String, String> initParams) {
        ...
        Map<String, S3ContextKeyDTO> s3KeyMapRes = this.convertMapToS3KeysMap(settings.getS3KeyMap());
    ...
    private Map<String, S3ContextKeyDTO> convertMapToS3KeysMap(Map<String, String> s3KeyMapSettings) {
        ...
        Map<String, S3ContextKeyDTO> s3KeyMapRes = new HashMap();
        ...
        while (var15.hasNext()) {
            ...
            if (access != null) {
                //TODO
                S3ContextKeyDTO pair = new S3ContextKeyDTO("", access, secret);
